								...
								<div class="">
									<div class="card-body">
										...
										<div class="row">
											<div class="col-sm-12">
												<div class="form-group floating-label" >
													<input type="checkbox" id="same" name = "same" value="1" <?php echo ($customer->getSame() == 1 ? "checked" : ""); ?> />
											...
											<div class="col-sm-6">
												<div class="form-group floating-label">
													<input type="text" name = "billing_address" class="form-control"  id="billing_address" value="<?php echo $customer->getBillingAddress(); ?>" required>
										...
										<div class="row">
											...
											<div class="col-sm-4">
												<div class="form-group floating-label">
													<input type="text" name = "billing_city" class="form-control" id="billing_city" required value="<?php echo $customer->getBillingCity(); ?>">
													<label class="city">City</label>
												</div>
											</div>
											...
											<div class="col-sm-4">
												<div class="form-group floating-label">
													<input type="text" name = "billing_zip" class="form-control" id="billing_zip" required value="<?php echo $customer->getBillingZip(); ?>" >
													<label class="zip">Zip</label>
												</div>
											</div>
										</div>
